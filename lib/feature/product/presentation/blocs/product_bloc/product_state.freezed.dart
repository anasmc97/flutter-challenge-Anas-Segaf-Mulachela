...
mixin _$ProductState {
  ...
  Option<Either<Failure, List<Product>>> get productsOrFailureOption =>
...
abstract class $ProductStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      Option<Either<Failure, List<Product>>> productsOrFailureOption,
      Status status});
}
...
class _$_ProductState implements _ProductState {
  ...
  @override
  final Option<Either<Failure, List<Product>>> productsOrFailureOption;
  @override
  final Status status;

  @override
  String toString() {
    return 'ProductState(products: $products, productsOrFailureOption: $productsOrFailureOption, status: $status)';
  }
...
abstract class _ProductState implements ProductState {
  const factory _ProductState(
      {required final List<Product> products,
      required final Option<Either<Failure, List<Product>>>
          productsOrFailureOption,
      required final Status status}) = _$_ProductState;
